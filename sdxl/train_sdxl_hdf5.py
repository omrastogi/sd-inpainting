...
from hdf5dataset import HDF5Dataset, collate_fn
...
def log_validation(
    ...
    for i in tqdm(range(len(test_df)), desc="Validation Progress"):
        hdf5_data, caption, path = get_data(i)
...
def main(args):
    ...
    train_dataset = HDF5Dataset(
        args.train_data_dir, df, tokenizer, args.resolution, xl=True
    )
