...
def main(args):
    ...
    df = pd.read_csv(os.path.join(args.train_data_dir, "train.csv"))
    if args.max_train_samples is not None:
        df = df.head(args.max_train_samples)
    test_df = pd.read_csv(os.path.join(args.train_data_dir, "test.csv"))
